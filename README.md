...
- service/scraper.py - основной скрипт скрапера, содержащий логику обхода и фильтрации.
...
- GET /get_list: Возвращает список всех найденных ссылок и их заголовков из базы данных.
